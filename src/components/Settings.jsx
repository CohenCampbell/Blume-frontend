    ...
    <div className="flex justify-center h-screen">
      ...
      >
        ...
        <div className="bg-sky-400 p-3 rounded shadow flex flex-col justify-center items-center">
          ...
          <button
            type="submit"
            className="px-4 py-1 mt-2 text-stone-800 shadow inline-flex items-center bg-red-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded text-center"
          >
            Delete
          </button>
        </div>
